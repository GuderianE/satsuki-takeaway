  ...
  return (
    <article>
      <section className='restaurant_info'>
        ...
        <p>
          Authentique et unique dans la région, voici votre Restaurant japonais
          ! Dans son cadre épuré et climatisé, où règne le calme ambiant, vous
          apprécierez les grands classiques que sont les Sushi, Sashimi,
          Tempura, Tonkatsu, Sukiyaki... proposés par le chef japonais Tatsuya
          Ishizaki, servis avec gentillesse et disponibilité ; si vous le
          souhaitez, tous nos plats peuvent être emportés.
        </p>
      </section>
      <section
        className='take_away'
          ...
          <div className='menu_card'>
            ...
            <div className='text_container'>
              ...
              <p>
                ...
                facilisis in, egestas eget quam. Sed posuere consectetur est at
                lobortis. Maecenas faucibus mollis interdum. Nulla vitae elit
                libero a pharetra.
              </p>
            </div>
          </div>
