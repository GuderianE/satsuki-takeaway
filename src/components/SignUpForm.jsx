...
export const SignUpForm = () => {
    ...
    return (
        (formSubmitted ? <SignUpConfirmation state={setFormSubmitted} /> : <form onSubmit={handleSubmit(onSubmit)}>
            <div>
            ...
            <div>
                ...
                <input type="radio" name="useragreement" ref={register({ required: true })} />
                {errors.useragreement && <small>please agree to the user agreement!</small>}
            </div>
